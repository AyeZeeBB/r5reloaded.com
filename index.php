        ...
        <div class="background">
          ...
          <div class="welcome" style="background-image: url('./img/banner.png');">
            <div class="description" style="width:100%">
              <p style="width:50%">Welcome To R5Reloaded</p>
              <h1 style="width:50%">An Apex Legends Modding SDK</h1>
              <div class="block-content2" style="width:90%">
                <a href="https://github.com/Mauler125/r5sdk/releases/latest" class="downloadbutton"
                  style="margin-right: 10px;box-shadow: 0px 0px 10px #00000090;">Download</a>
                <a href="https://discord.gg/r5reloaded" class="discordbutton button-right"
                  style="margin-right: 10px;box-shadow: 0px 0px 10px #00000090"><img src="./img/discord.png" alt="logo"
                    width="30" title="Discord" /></a>
                <a href="https://github.com/Mauler125/r5sdk" class="githubbutton"
                  style="margin-right: 10px;box-shadow: 0px 0px 10px #00000090;"><img src="./img/github.png" alt="logo"
                    width="50" title="Github" /></a>
                <a href="https://trello.com/b/ymr4R3j9/r5reloaded" class="trellobutton"
                  style="box-shadow: 0px 0px 10px #00000090;"><img src="./img/trello.png" alt="logo" width="50"
                    title="Trello" /></a>
              </div>
            </div>
          </div>
